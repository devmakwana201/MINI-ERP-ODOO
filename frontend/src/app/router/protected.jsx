    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "manufacturing",
            children: [
              { index: true, element: <Navigate to="/manufacturing/orders" /> },
              { path: "orders", lazy: async () => ({ Component: (await import("app/pages/manufacturing/orders")).default }) },
              { path: "orders/new", lazy: async () => ({ Component: (await import("app/pages/manufacturing/orders/form")).default }) },
              { path: "boms", lazy: async () => ({ Component: (await import("app/pages/manufacturing/boms")).default }) },
              { path: "boms/new", lazy: async () => ({ Component: (await import("app/pages/manufacturing/boms/form")).default }) },
              { path: "boms/:id", lazy: async () => ({ Component: (await import("app/pages/manufacturing/boms/form")).default }) },
            ],
          },
          {
            path: "incoming-goods",
